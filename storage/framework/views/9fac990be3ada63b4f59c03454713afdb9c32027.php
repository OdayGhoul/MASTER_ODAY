                ...
                <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="width: 250px">
                    ...
                    <div class="package-item">
                        <div class="overflow-hidden">
                            ...
                            <img class="img-fluid" src="<?php echo e(asset('storage/image/mohd.jpeg')); ?>" alt="" style="height: 260px; margin-left:25px; ">
                        </div>
                    ...
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="width: 250px">
                        ...
                        <div class="package-item">
                            <div class="overflow-hidden">
                                ...
                                <img class="img-fluid" src="<?php echo e(asset('storage/image/huda.png')); ?>" alt="" style="height: 260px; padding:15px">
                            </div>
                            <div class="d-flex border-bottom">
                ...
                <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s"  style="width: 250px">
                    ...
                    <div class="package-item">
                        <div class="overflow-hidden">
                            ...
                            <img class="img-fluid" src="<?php echo e(asset('storage/image/oday.png')); ?>" alt="" style="height: 260px;">
                        </div>
                        <div class="d-flex border-bottom">
                    ...
                    <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="width: 250px">
                        ...
                        <div class="package-item">
                            <div class="overflow-hidden">
                                ...
                                <img class="img-fluid" src="<?php echo e(asset('storage/image/tabarak.png')); ?>" alt="" style="height: 260px;">
                            </div>
                            <div class="d-flex border-bottom">
                        ...
                        <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="width: 250px">
                            ...
                            <div class="package-item">
                                <div class="overflow-hidden">
                                    ...
                                    <img class="img-fluid" src="<?php echo e(asset('storage/image/noor.png')); ?>" alt="" style="height: 260px;">
                                </div>
                                <div class="d-flex border-bottom">
