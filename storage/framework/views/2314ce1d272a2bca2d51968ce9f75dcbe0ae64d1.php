    ...
    <div class="row gx-0">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                ...
                <small class="text-light"><i class="fa fa-envelope-open me-2"></i>petra@gmail.com</small>
            </div>
        </div>
...
<div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        <a href="<?php echo e(route('user.index')); ?>" class="navbar-brand p-0">
            <h1 class="text-primary m-0"><i class="fa fa-map-marker-alt me-3"></i>PETRA</h1>
...
<?php /**PATH C:\xampp\htdocs\master_p\resources\views/publicUser/navbar.blade.php ENDPATH**/ ?>