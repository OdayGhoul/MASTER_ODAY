  ...
  <aside class="main-sidebar elevation-4" style="background-color:#dddddd">
    ...
    <a href="<?php echo e(route('admin.index')); ?>" class="brand-link">
      ...
      <span class="brand-text font-weight-medium" style="color:#055ea2 ">PETRA</span>
    </a>
...
<?php /**PATH C:\xampp\htdocs\master_p\resources\views/admin/layouts/main-sidebar.blade.php ENDPATH**/ ?>